...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory('rover_proyect')
    ...
    model_path = get_model_paths(['rover_proyect'])

    robot_description_launcher = IncludeLaunchDescription(PathJoinSubstitution(
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("rover_proyect"), "rviz", "robot.rviz"]
    )
    ...
    gz_image_bridge_node = Node(
        ...
        arguments=["/front/image", "/arm/image"],
        output="screen",
        parameters=[
            {'use_sim_time': True,
